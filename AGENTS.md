...
- `outbox-core/src/main/java/outbox/core`: core APIs and runtime (client, dispatcher, poller, registry, repo contracts).
...
- Package names follow `outbox.<module>` (for example, `outbox.core.dispatch`).
