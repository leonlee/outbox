...
public final class JdbcTemplate {
  ...
  public static int update(Connection conn, String sql, Object... params) {
    try (PreparedStatement ps = conn.prepareStatement(sql)) {
      ...
      throw new OutboxRepositoryException("Failed to execute update", e);
    }
  }
  ...
  public static <T> List<T> query(Connection conn, String sql, RowMapper<T> mapper, Object... params) {
    try (PreparedStatement ps = conn.prepareStatement(sql)) {
      ...
      throw new OutboxRepositoryException("Failed to execute query", e);
    }
  }
  ...
  public static <T> List<T> updateReturning(Connection conn, String sql, RowMapper<T> mapper, Object... params) {
    try (PreparedStatement ps = conn.prepareStatement(sql)) {
      ...
      throw new OutboxRepositoryException("Failed to execute updateReturning", e);
    }
  }
