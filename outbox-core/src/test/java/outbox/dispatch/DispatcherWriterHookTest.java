...
class DispatcherWriterHookTest {
  ...
  static final class CountingMetrics implements MetricsExporter {
    ...
    @Override public void incrementHotEnqueued() { hotEnqueued.incrementAndGet(); }
    @Override public void incrementHotDropped() { hotDropped.incrementAndGet(); }
    @Override public void incrementColdEnqueued() { coldEnqueued.incrementAndGet(); }
